...
$lang = array_merge($lang, array(
	...
	<br>
	您同意不张贴任何带有辱骂，淫秽，粗俗，诽谤，仇恨，威胁，色情的内容，不张贴任何带有侵犯您所在国家的法律， “%1$s” 所在国家的法律，国际公法的内容。以上的行为可能会使您在未得到通知的情况下被永远禁止访问这个论坛。所有帖子发表所使用的 IP 地址将被记录，以协助调查违反条款的事件。您同意 “%1$s” 具有在任何我们认为合适的时候删除，修改，移动，或关闭任何话题的权力。作为一个用户，您同意您所输入的任何信息将被记录至数据库。在没有得到您同意的前提下我们不会向任何第三方发布这些信息，但是 “%1$s” 不为任何因为黑客行为导致的数据泄漏承担法律责任.
	',

	'PRIVACY_POLICY'		=> '这个策略用于细节化地解释 “%1$s” 和其附属的公司 (下文中指代 “我们”, “我方”， “我们的”， “%1$s”, “%2$s”) 如何使用在与您的对话中得到的与您有关的信息 (下文中指代 “您的信息”)。<br>
	<br>
	您的信息通过两种方式产生。 首先， 通过浏览 “%1$s” 将在您的电脑中生成一定数量的 cookie 文件， 这些 cookie 是浏览器用于缓存信息的临时文件。 其中前两个 cookie 包含用户的ID信息 (下文指代 “用户ID”) 和一个匿名的用户对话ID (下文中指代 “对话ID”)， 将被本软件指派自动生成。 第三个cookie 将在您浏览 “%1$s” 中的主题后自动产生， 用于存储您的浏览历史信息， 用于提高用户体验。<br>
	<br>
	本软件在浏览 “%1$s” 时，除了上述的 cookies 外，或许我们会使用其它外部 cookie 来储存信息， 但这已经超出了本文档的范围。 第二种是我们通过您在软件中提交的内容收集到的您的信息。 这种情况是但是不局限于: 以匿名用户发帖 (下文中指代 “匿名帖子”)， 在 “%1$s” 上注册帐号 (下文中指代 “您的帐号”) 登录动作和您在注册后发表的帖子 (下文中指代 “您的帖子”)。<br>
	<br>
	您的帐号将至少包含一个唯一的用户名 (下文中指代 “您的用户名”)， 一个用于登录您的帐号的个人密码 (下文中指代 “您的密码”) 和一个个人的， 有效的 email 地址 (下文中指代 “您的 email”)。 您在 “%1$s” 上的帐号所包含的信息将受到我们的主机所在国家的数据保护法律的保护。 除了您的用户名和您的密码以及在注册过程中 “%1$s” 要求的email地址以外， 您的其他任何信息都是可选的(除了软件使用者的特殊要求)。 在任何情况下， 您可以选择您的信息是否被公开。 此外， 在您的帐号中， 您可以选择定向收发本软件自动生成的email。<br>
	<br>
	您的密码在软件中以加密形式存在 (不可逆算法)， 所以它是安全的。 但是， 我们希望您不要在不同的网站上使用相同的用户名和密码。 您的密码是您在  “%1$s” 上访问您的帐号的唯一途径， 所以请谨慎保管您的密码并且在任何情况下不会有任何与 “%1$s” 相关的个人或单位， 或者任何第三方组织需要您提供您的密码。 如果您不慎遗失您的密码， 您可以使用本软件提供的 “我忘记了自己的密码” 功能。 在找回密码的过程中您将要回答您的用户名和您的email， 而后本软件将会提供一个新的密码让您取回帐号。<br>
	',
));
...
$lang = array_merge($lang, array(
	...
	'BOARD_DATE_FORMAT_EXPLAIN'	=> '时间格式设置语法同 PHP 相同，参考 <a href="https://secure.php.net/manual/function.date.php">date()</a> 函数',
	'BOARD_LANGUAGE'			=> '我的语言',
	'BOARD_STYLE'				=> '我的论坛风格',
	'BOARD_TIMEZONE'			=> '我的时区',
	'BOOKMARKS'					=> '收藏夹',
