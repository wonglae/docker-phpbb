...
$lang = array_merge($lang, array(
	...
	'ACP_VIGLINK_SUPPORT_EXPLAIN'	=> '在提交你所选择的首选项后，将不再重定向到此页面。',
	...
	'ACP_VIGLINK_DISABLED_PHPBB'	=> 'VigLink 服务已被 phpBB 停用。',
	'ACP_VIGLINK_CLAIM'				=> '收取您自己的收入',
	'ACP_VIGLINK_CLAIM_EXPLAIN'		=> '您可以不捐献通过 VigLink 的可收益链接赚取的收入给 phpBB 项目，转而收取这部分作为自己论坛的收入。点击 “Convert 账户” 来 申请注册一个 “VigLink Convert”，你就可以管理自己的账户。 ',
