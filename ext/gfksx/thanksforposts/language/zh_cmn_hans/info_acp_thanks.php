...
$lang = array_merge($lang, [
	'ACP_DELTHANKS' 											=> '删除记录的点赞',
	'ACP_POSTS' 													=> '总帖子数',
	'ACP_POSTSEND' 												=> '剩余带点赞的帖子',
	'ACP_POSTSTHANKS' 										=> '总点赞帖子数',
	'ACP_THANKS' 													=> '点赞帖子',
	'ACP_THANKS_MOD_VER' 									=> '扩展版本：',
	'ACP_THANKS_TRUNCATE' 								=> '清除点赞列表',
	'ACP_ALLTHANKS' 											=> '记录过的点赞',
	'ACP_THANKSEND' 											=> '剩余要记录的点赞',
	'ACP_THANKS_REPUT' 										=> '评级选项',
	'ACP_THANKS_REPUT_SETTINGS' 					=> '评级选项',
	'ACP_THANKS_REPUT_SETTINGS_EXPLAIN' 	=> '根据此处的点赞系统设置帖子、主题和论坛的默认评级设置。 <br /> 拥有最多点赞总数的主题（帖子、主题或论坛）将获得100%的评级。',
	'ACP_THANKS_SETTINGS' 								=> '点赞设置',
	'ACP_THANKS_SETTINGS_EXPLAIN' 				=> '可以在此处更改默认的帖子点赞设置。',
	'ACP_THANKS_REFRESH' 									=> '更新计数器',
	'ACP_UPDATETHANKS' 										=> '更新记录的点赞',
	'ACP_USERSEND' 												=> '剩余点赞的用户',
	'ACP_USERSTHANKS' 										=> '点赞的用户总数',
	...
	'IMG_THANKPOSTS'											=> '点赞帖子',
	'IMG_REMOVETHANKS'										=> '取消点赞',

	'LOG_CONFIG_THANKS'										=> '更新点赞帖子扩展的配置',

	'REFRESH'															=> '刷新',
	'REMOVE_THANKS' 											=> '删除点赞',
	'REMOVE_THANKS_EXPLAIN' 							=> '如果启用此选项，用户可以删除点赞。',

	'STEPR'																=> ' - 执行，步骤 %s',

	'THANKS_COUNTERS_VIEW'								=> '点赞计数器',
	'THANKS_COUNTERS_VIEW_EXPLAIN'				=> '如果启用，有关作者的块信息将显示已发出/已收到的点赞数量。',
	'THANKS_FORUM_REPUT_VIEW'							=> '显示论坛评级',
	'THANKS_GLOBAL_POST'									=> '全局公告中的点赞',
	'THANKS_GLOBAL_POST_EXPLAIN'					=> '如果启用，则启用全局公告中的点赞。',
	'THANKS_FORUM_REPUT_VIEW_EXPLAIN'			=> '如果启用，论坛评级将显示在论坛列表中。',
	'THANKS_INFO_PAGE'										=> '信息性消息',
	'THANKS_INFO_PAGE_EXPLAIN'						=> '如果启用，将在点赞/删除点赞帖子后显示信息性消息。',
	'THANKS_NOTICE_ON'										=> '通知可用',
	'THANKS_NOTICE_ON_EXPLAIN'						=> '如果启用，则通知可用，用户可以通过您的个人资料配置通知。',
	'THANKS_NUMBER'												=> '在个人资料中显示的点赞列表中的点赞者数量',
	'THANKS_NUMBER_EXPLAIN'								=> '查看个人资料时显示的点赞的最大数量。 <br /> <strong>请记住，如果将此值设置为超过250，则会注意到减速。</strong>',
	...
	'THANKS_NUMBER_POST'									=> '在帖子中列出的点赞者数量',
	'THANKS_NUMBER_POST_EXPLAIN'					=> '查看帖子时显示的点赞者的最大数量。 <br /> <strong>请记住，如果将此值设置为超过250，则会注意到减速。</strong>',
	'THANKS_ONLY_FIRST_POST' 							=> '仅适用于主题中的第一篇帖子',
	'THANKS_ONLY_FIRST_POST_EXPLAIN' 			=> '如果启用，则用户只能点赞主题中的第一篇帖子。',
	'THANKS_POST_REPUT_VIEW' 							=> '显示帖子评级',
	'THANKS_POST_REPUT_VIEW_EXPLAIN' 			=> '如果启用，则在查看主题时将显示帖子评级。',
	'THANKS_POSTLIST_VIEW' 								=> '在帖子中列出点赞',
	'THANKS_POSTLIST_VIEW_EXPLAIN' 				=> '如果启用，则将显示点赞作者帖子的用户列表。<br/> 请注意，仅当管理员在该论坛中启用了点赞帖子的权限时，此选项才有效。',
	'THANKS_PROFILELIST_VIEW' 						=> '在个人资料中列出点赞',
	'THANKS_PROFILELIST_VIEW_EXPLAIN' 		=> '如果启用，则将显示点赞列表，包括点赞次数以及用户被点赞的帖子。',
	'THANKS_REFRESH' 											=> '更新点赞计数器',
	'THANKS_REFRESH_EXPLAIN' 							=> '在此处，您可以在批量删除帖子/主题/用户、拆分/合并主题、设置/删除全局公告、启用/禁用“仅适用于主题中的第一篇帖子”选项、更改帖子所有者等后更新点赞计数器。这可能需要一些时间。<br /><strong>重要提示：为了正确工作，刷新计数器函数需要MySQL 4.1或更高版本！<br />注意！<br />-刷新将删除所有来宾帖子的点赞！<br />-如果“全局公告中的点赞”选项关闭，则刷新将删除所有全局公告的点赞！<br />-如果“仅适用于主题中的第一篇帖子”选项打开，则刷新将删除除主题中的第一篇帖子以外的所有帖子的点赞！</strong>',
	'THANKS_REFRESH_MSG' 									=> '这可能需要几分钟才能完成。所有不正确的点赞条目都将被删除！<br />操作不可逆！',
	...
	'THANKS_TIME_VIEW' 										=> '点赞时间',
	'THANKS_TIME_VIEW_EXPLAIN' 						=> '如果启用，则帖子将显示点赞时间。',
	...
	'TRUNCATE' 														=> '清除',
	'TRUNCATE_THANKS' 										=> '清除点赞列表',
	'TRUNCATE_THANKS_EXPLAIN' 						=> '此过程完全清除所有点赞计数器（删除所有已发出的点赞）。<br />此操作不可逆！',
	'TRUNCATE_THANKS_MSG' 								=> '点赞计数器已清除。',
	'REFRESH_THANKS_CONFIRM' 							=> '您真的要刷新点赞计数器吗？',
	'TRUNCATE_THANKS_CONFIRM' 						=> '您真的要清除点赞计数器吗？',
	'TRUNCATE_NO_THANKS' 									=> '操作已取消',
	'ALLOW_THANKS_PM_ON' 									=> '如果有人点赞我的帖子，请通知我PM',
	'ALLOW_THANKS_EMAIL_ON' 							=> '如果有人点赞我的帖子，请通知我电子邮件',
]);
