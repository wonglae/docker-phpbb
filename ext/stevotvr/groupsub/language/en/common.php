...
$lang = array_merge($lang, array(
	...
	'GROUPSUB_BUY_WITH_STRIPE'	=> 'Donate now',
	'GROUPSUB_ALREADY_SUBSCRIBED'	=> 'You already have this lifetime membership.',
	'GROUPSUB_PLAN_INVALID'		=> 'This package term must have a positive price in a supported currency.',
	...
	'GROUPSUB_RETURN_MESSAGE'	=> 'You have subscribed to <strong>%1$s</strong> for %2$s. Payment processing and activation normally take a few minutes. If your account status has not changed after 30 minutes, contact an <a href="https://www.wowang.net/memberlist.php?mode=contactadmin">administrator</a> and provide the payment reference below.',
	'GROUPSUB_RETURN_REFERENCE'	=> 'Payment reference:',
